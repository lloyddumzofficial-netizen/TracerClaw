      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        {status === "uploading" && (
          <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "20px" }}>
            <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ position: "absolute", width: "100px", height: "100px", border: "4px solid rgba(255,204,0,0.2)", borderRadius: "50%" }}></div>
              <Loader2 size={48} color="#ffcc00" className="animate-spin" />
            </div>
        ...
        {status === "success" && (
          <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
            <div style={{ background: "rgba(255,204,0,0.1)", padding: "24px", borderRadius: "50%", marginBottom: "10px" }}>
              <CheckCircle2 size={64} color="#ffcc00" />
            </div>
        ...
        {status === "error" && (
          <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
            <h2 style={{ margin: 0, fontSize: "24px", fontWeight: "700", color: "#ffcc00" }}>Upload Failed</h2>
