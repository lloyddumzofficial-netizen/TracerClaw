  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0a0a0a", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px", fontFamily: "var(--font-manrope), 'Segoe UI', Arial, sans-serif" }}>
      <div style={{ maxWidth: "520px", textAlign: "center" }}>
        ...
        <Link
          href="/"
          style={{ display: "inline-block", padding: "12px 24px", border: "none", borderRadius: "6px", background: "#FFD700", color: "#000", fontWeight: 600, fontSize: "15px", textDecoration: "none" }}
        >
          Back to home
        </Link>
      </div>
